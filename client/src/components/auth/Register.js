                    ...
                    <p className="my-2 text-bold lead">Select type of account</p>
                        <div className="acc-type">
                            <div className="item student">
                                <input id="student" type="radio" name="account_type" onChange={()=> setFormData({ ...formData, account_type: 'patient'}) } />
                            ...
                            <div className="item teacher">
                                <input id="teacher" type="radio" name="account_type" onChange={()=> setFormData({ ...formData, account_type: 'stuff'}) } />
