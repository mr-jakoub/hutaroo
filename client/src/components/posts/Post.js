...
const Post = ({post, addComment, comments, auth:{ user }, profilePosts, deletePost, addLike, addRise}) => {
    ...
    return (
        <div className={risedPost?"post blured-background rised":"post blured-background"}>
            ...
            <div className="nmbrs">
                <div>
                    <span className='underline svg-icon'>
                        <svg viewBox="0 0 412.735 412.735">
                            <g>
                                <g>
                                    <path fill='var(--Danger-color)' d={filledLike} />
                                </g>
                            </g>
                        </svg>
                    </span>
                    <span className='underline svg-icon next-icon'>
                    ...
                    <span style={{margin: "0"}} className='underline'>                            
                        {post.likes.length + post.rises.length === 0?'':post.likes.length + post.rises.length}
                    </span>
                </div>
                <div>
